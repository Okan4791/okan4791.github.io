...
try {
  ...
  for (const width of [390, 1440]) {
    ...
    if (captureEvidence) {
      await captureSequence(width, 'hobbies', '#off-the-clock', [0, 200, 360, 600, 720, 800, 840, 960, 1080, 1200, 1440, 1600, 1920, 2400, 2600, 2880, 3200, 3360, 3600, 4000, 4400, 4800, 5200, 5600, 5760, 6200, 6240, 6480, 6800, 7000, 7200, 7600, 7680, 7920, 8000, 8200, 8400, 8800, 9000, 9120, 9360, 9600, 10000, 10400, 10800, 11000, 11200, 11520, 12000, 12480, 12960, 13200, 13600, 14000, 14400, 14800, 15200, 15600, 15840, 16000, 16560, 16800, 17200, 18000, 18960, 20000, 20160, 21000, 21600, 21840, 22000, 22400, 23280]);
