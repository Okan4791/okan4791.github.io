...
try {
  ...
  if(people.manRatio<4.5||people.manRatio>6.5||people.womanRatio<4.5||people.womanRatio>6.5||people.faces!==4||people.necks!==4||people.hands<7||people.shoes!==4||people.clothes!==4||people.hairDetails!==2||people.hair.length!==2||people.hair.some((hair)=>hair.width<8||hair.height<6||hair.fill==='none')||people.dogs.length!==2||people.dogs.some((dog)=>dog.ratio<1.4||dog.ratio>2.1||dog.legDrop<6||dog.eye!==1||dog.feathering!==1))throw new Error(`SVG figure detail regression: ${JSON.stringify(people)}`);
