...
try {
  ...
  if (!catchValue.behindRim || catchValue.samples[0].traveler + catchValue.samples[0].caught < .8 || catchValue.samples[2].traveler > .1 || catchValue.samples[2].caught < .9) throw new Error(`SVG basket catch regression: ${JSON.stringify(catchValue)}`);
